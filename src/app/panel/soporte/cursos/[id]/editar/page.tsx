...
export default function EditarCursoPage() {
  ...
  useEffect(() => {
    ...
    setPricePen(course.price_pen?.toString() ?? "");
    setDiscountPricePen(course.discount_price_pen?.toString() ?? "");
    setPriceUsd(course.price_usd?.toString() ?? "");
    setDiscountPriceUsd(course.discount_price_usd?.toString() ?? "");
    setAccessDurationMonths(course.access_duration_months?.toString() ?? "");
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-brand-primary">Editar curso</h1>
        ...
        <Tabs defaultValue="basico">
          ...
          <TabsContent value="config" className="space-y-6">
            ...
            <div className="space-y-4 pt-5 border-t border-gray-200">
              <div>
                <h3 className="font-medium text-brand-primary">Modo de certificación</h3>
                <p className="text-sm text-gray-500 mt-0.5">
