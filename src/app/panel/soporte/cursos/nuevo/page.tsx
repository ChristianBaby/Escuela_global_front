...
export default function NuevoCursoPage() {
  ...
  const createMutation = useMutation({
    mutationFn: async (forceDraft: boolean) => {
      ...
      const courseId = response?.course?.id ?? (response as unknown as { id?: string })?.id;
    ...
    onError: (err: unknown) => {
      ...
      toast.error(msg ?? "Error al crear el curso");
    },
  });
          ...
          <TabsContent value="basico" className="space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-gray-400">
                  Auto-generado. URL pública: /cursos/
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                placeholder="Descripción detallada del curso: contenido, metodología, para quién va dirigido..."
                rows={7}
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="pt-1 space-y-1.5">
                  ...
                  <p className="text-xs text-gray-400">
                    {thumbnail ? thumbnail.name : "Ningún archivo seleccionado"}
                  </p>
                  <input
                    ref={fileInputRef}
                    type="file"
          ...
          <TabsContent value="config" className="space-y-6">
            ...
            <div className="pt-5 border-t border-gray-200 flex items-center justify-between">
              ...
              <div className="flex gap-3">
                ...
                >
                  {createMutation.isPending ? "Guardando..." : "Guardar como borrador"}
                </button>
                <button
                  type="button"
